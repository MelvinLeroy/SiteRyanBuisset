...
<div class="landing">
    ...
    <div class="section section-odd clear" style="background: url(<?php echo YITH_WCBM_ASSETS_URL ?>/images/14-bg.png) no-repeat #f1f1f1; background-position: 15% 100%">
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_WCBM_ASSETS_URL ?>/images/14-icon.png" alt="icon 14" />
            ...
            <div class="col-1">
                <img src="<?php echo YITH_WCBM_ASSETS_URL ?>/images/14.png" alt="out of stock products" />
            </div>
        </div>
    </div>
    <div class="section section-cta section-odd">
